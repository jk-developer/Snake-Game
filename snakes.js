    ...
    snake = {
        ...
        drawSnake : function(){
            this.cells.forEach(function(cell){
                pen.fillStyle = snake.color; // this works differntly in for each loop
...
function generateParticle(){
    var x = Math.round(Math.random()*(W -20)/20); // Multiples of 20 because of snake size
